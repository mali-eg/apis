...
function $StateProvider(   $urlRouterProvider,   $urlMatcherFactory,           $locationProvider) {
   ...
   *
   * In addition, users.json can attach custom decorators, which will generate new
 ...
 *     <a ui-sref="app.user({user: 'bilbobaggins'})" href="/users.json/bilbobaggins">@bilbobaggins</a>
 *   </li>
 * </ul>
 * </pre>
 * 
